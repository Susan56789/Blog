...
export const Articles: Article[]=[
    {
       id:1 ,
       title:"HELLO WORLD",
       content:"We are made for goodness. We are made for love...We are made for all of the beautiful things that you and I know. We are made to tell the world that there are no outsiders...all are welcome.",
    ...
    },
    {
        ...
        content:"The end of the year is a time of year for remembrance. We take stock of where we came from, and have a moment to think about where we are going, as we pursue the future with hope. May your new year be all that you hope for, and may it be sprinkled with love and friendship. Happy Holidays!",
